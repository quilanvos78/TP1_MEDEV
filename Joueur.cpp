...
void Joueur::avancer(int cube_size,&vector<avion*> avions, int i):avion(){//i correspond à la place de l'avion dans le vecteur, ne pas oublier de mettre le bon argument dans le main
